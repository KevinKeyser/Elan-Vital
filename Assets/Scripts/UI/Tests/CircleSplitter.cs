    ...
    public class CircleSplitter : MonoBehaviour
    {
        ...
        private void CreateChildren()
        {
            ...
            for (int i = 0; i < splitAmount; i++)
            {
                ...
                children[i] = Instantiate(PrefabSlice, transform.position + new Vector3(direction.x, direction.y),
                    Quaternion.Euler(0, 0, currentTriangleDeg), this.transform);
